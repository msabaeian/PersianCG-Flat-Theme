...
*/					
			/* Options Page1 - Site Interface */		
					
	$options[] = array( "name" => __('اسلایدر','framework_localize'),
			"type" => "heading");				
			
			
			$options[] = array( "name" => __('تغییر جمله ی اسلاید اول','framework_localize'),
			"desc" => "تغییر جمله ی اسلاید اول",
			"id" => $shortname."_jomle1",
			"std" => "",
			"type" => "text");
			$options[] = array( "name" => __('عکس اسلاید اول ','framework_localize'),
			"desc" => __('عکس اسلاید اول','framework_localize'),
			"id" => $shortname."_img1",
			"std" => "",
			"type" => "upload");
			
			$options[] = array( "name" => __('تغییر جمله ی اسلاید دوم','framework_localize'),
			"desc" => "تغییر جمله ی اسلاید دوم",
			"id" => $shortname."_jomle2",
			"std" => "",
			"type" => "text");
			$options[] = array( "name" => __('عکس اسلاید دوم ','framework_localize'),
			"desc" => __('عکس اسلاید دوم','framework_localize'),
			"id" => $shortname."_img2",
			"std" => "",
			"type" => "upload");
			
			$options[] = array( "name" => __('تغییر جمله ی اسلاید سوم','framework_localize'),
			"desc" => "تغییر جمله ی اسلاید سوم",
			"id" => $shortname."_jomle3",
			"std" => "",
			"type" => "text");
			$options[] = array( "name" => __('عکس اسلاید سوم ','framework_localize'),
			"desc" => __('عکس اسلاید سوم','framework_localize'),
			"id" => $shortname."_img3",
			"std" => "",
			"type" => "upload");
			
			$options[] = array( "name" => __('تغییر جمله ی اسلاید چهارم','framework_localize'),
			"desc" => "تغییر جمله ی اسلاید چهارم",
			"id" => $shortname."_jomle4",
			"std" => "",
			"type" => "text");
			$options[] = array( "name" => __('عکس اسلاید چهارم ','framework_localize'),
			"desc" => __('عکس اسلاید چهارم','framework_localize'),
			"id" => $shortname."_img4",
			"std" => "",
			"type" => "upload");
