...
function propanel_siteoptions_add_admin() {
    ...
    $tt_page = add_theme_page('Site Options', 'تنظیمات سایت', 'edit_theme_options', 'siteoptions','propanel_siteoptions_options_page');
...
<div class="wrap" id="truethemes_container">
  <div id="of-popup-save" class="of-save-popup">
    <div class="of-save-save">تنظیمات به روز شد</div>
  </div>
  <div id="of-popup-reset" class="of-save-popup">
    <div class="of-save-reset">تنظیمات به حالت اولیه بازگشت</div>
  </div>
  <form action="" enctype="multipart/form-data" id="ofform">
    ...
    <input type="submit" value="ذخیره ی تنظیمات" class="button-primary" />
  </form>
  <form action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" method="post" style="display:inline" id="ofform-reset">
    <span class="submit-footer-reset">
    <input name="reset" type="submit" value="بازگرداندن به حالت اولیه" class="button submit-button reset-button" onclick="return confirm('CAUTION: Any and all settings will be lost! Click OK to reset.');" />
